...
public class TestDb : IAsyncDisposable
{
    ...
    private string ConnectionString =>
        $"Host=127.0.0.1;Port=5432;Database={_dbName};Username=fasolt;Password=fasolt_dev";
    ...
    public async ValueTask DisposeAsync()
    {
        await using var conn = new Npgsql.NpgsqlConnection(
            "Host=127.0.0.1;Port=5432;Database=postgres;Username=fasolt;Password=fasolt_dev");
