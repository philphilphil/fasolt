...
android {
    namespace = "com.fasolt.android"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.fasolt.android"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "0.1.0"
        ...
        // AppAuth intent filter — must match the OAuth redirect URI scheme.
        // Matches iOS scheme so the backend doesn't need a separate redirect entry.
        manifestPlaceholders["appAuthRedirectScheme"] = "fasolt"
    }
