...
export function deserializeIntoMdHeading(mdHeading: Partial<MdHeading> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "level": n => { mdHeading.level = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
        "lineNumber": n => { mdHeading.lineNumber = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
    }
}
/**
 * The deserialization information for the current model
...
export function serializeMdHeading(writer: SerializationWriter, mdHeading: Partial<MdHeading> | undefined | null = {}) : void {
    if (mdHeading) {
        ...
        writer.writeObjectValue("level", mdHeading.level);
        writer.writeObjectValue("lineNumber", mdHeading.lineNumber);
