 ...
 * Creates a new instance of the appropriate class based on discriminator value
 * @param parseNode The parse node to use to read the discriminator value and create the object
 * @returns {MdFileRequest}
 */
// @ts-ignore
export function createMdFileRequestFromDiscriminatorValue(parseNode: ParseNode | undefined) : ((instance?: Parsable) => Record<string, (node: ParseNode) => void>) {
    return deserializeIntoMdFileRequest;
}
/**
 * Creates a new instance of the appropriate class based on discriminator value
 * @param parseNode The parse node to use to read the discriminator value and create the object
 ...
 */
// @ts-ignore
export function deserializeIntoMdFileRequest(mdFileRequest: Partial<MdFileRequest> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "id": n => { mdFileRequest.id = n.getGuidValue(); },
    }
}
/**
 * The deserialization information for the current model
...
export interface MdFileRequest extends AdditionalDataHolder, Parsable {
    /**
     * Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
     */
    additionalData?: Record<string, unknown>;
 ...
 */
// @ts-ignore
export function serializeMdFileRequest(writer: SerializationWriter, mdFileRequest: Partial<MdFileRequest> | undefined | null = {}) : void {
    if (mdFileRequest) {
        writer.writeGuidValue("id", mdFileRequest.id);
        writer.writeAdditionalData(mdFileRequest.additionalData);
    }
}
/**
 * Serializes information the current object
